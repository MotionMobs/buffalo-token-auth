...
func init() {
	...
	generateCmd.Flags().StringSliceVarP(&generateOptions.UserFields, "user-fields", "u", []string{}, "fields to add to the user model, other than email, password, and id")
	generateCmd.Flags().StringVarP(&generateOptions.Prefix, "token-prefix", "pre", "", "prefix for use in the JWT generated by the middleware")
